...
- анимации (разные, переходов, перемещений задач, обновлений и т.д. для интерактива)
- намутить типо анимацию, которая привлекает к нажатию на имя чтобы типо сменить его дефолтное
- анимации по нажатию на элементы списка (на сами элементы и на кнопки)
...
- детект зажатия на элементе и работа с этим
